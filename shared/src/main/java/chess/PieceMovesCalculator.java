...
//    public Collection<ChessMove> PawnMovesCalculator(ChessGame.TeamColor teamColor, ChessPiece.PieceType pieceType, ChessPosition position, ChessBoard Board) {
//        ArrayList<ChessMove> moves = new ArrayList<>();
//        int row = position.getRow();
//        int col = position.getColumn();
//        int upd_row = position.getRow();
...
//        if (piece_2 != null) {
//            if (piece_2.getTeamColor() != teamColor) {
//                moves.add(new ChessMove(position, new ChessPosition(upd_row, upd_col), pieceType));
//            }
//        }
//        upd_row -= 2;
